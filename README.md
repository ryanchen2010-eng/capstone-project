...
embed and a public GitHub/jsDelivr SDF URL. Replace the placeholder repository
and file path in this starter snippet:
...
<script>
  ...
  fetch("https://cdn.jsdelivr.net/gh/YOUR_GITHUB_USERNAME/YOUR_REPO@main/public/molecules/water.sdf")
